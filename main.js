let originalURL = 'https://docs.google.com/spreadsheets/d/1dtenl7Cc9R_UcKxnYvCeOFT9IaOwFw46JcxnquZYR_k/edit#gid=0'

let id = '1dtenl7Cc9R_UcKxnYvCeOFT9IaOwFw46JcxnquZYR_k'

let source = 'https://spreadsheets.google.com/feeds/list/1dtenl7Cc9R_UcKxnYvCeOFT9IaOwFw46JcxnquZYR_k/od6/public/values?alt=json'

fetch(source)
  .then( res => res.json())
  .then( data => {
    console.log('this is data feed', data.feed.entry)
